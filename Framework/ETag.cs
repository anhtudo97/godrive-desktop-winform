...
namespace VirtualFileSystem
{
    ...
    internal static class ETag
    {
        ...
        public static async Task<string> GetETagAsync(string userFileSystemPath)
        {
            ...
            return File.ReadAllText(eTagFilePath);
        }
        ...
        public static string GetETagFilePath(string userFileSystemPath)
        {
            ...
            string path = $"{Helper.TrimEndingDirectorySeparator(PersonalProvider.GetRemotePath(userFileSystemPath))}{relativePath}.etag";
            return path;
        }
