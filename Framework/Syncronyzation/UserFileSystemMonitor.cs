...
namespace VirtualFileSystem.Syncronyzation
{
    ...
    internal class UserFileSystemMonitor : IDisposable
    {
        ...
        internal UserFileSystemMonitor(string userFileSystemRootPath) : base()
        {
        ...
        private async void CreatedAsync(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                ...
                if (FsPath.Exists(userFileSystemPath) && !PlaceholderItem.IsPlaceholder(userFileSystemPath))
                {
                    ...
                    Debug.WriteLine("Converted to placeholder", userFileSystemPath);
                    ...
                    if (!FsPath.AvoidSync(userFileSystemPath))
                    {
                        ...
                        {
                            Debug.WriteLine("Creation in remote storage failed. Possibly in use by an application", userFileSystemPath, null, ex);
                        }
                    }
                }
            }
            ...
            {
                Debug.WriteLine($"{e.ChangeType} failed", userFileSystemPath, null, ex);
            }
        }
        ...
        {
            Debug.WriteLine(e.ChangeType.ToString(), e.FullPath);
        }
